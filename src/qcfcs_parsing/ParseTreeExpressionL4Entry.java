...
/**
 * This class extends the AbstractParseTreeExpressionEntry to implement a level 4 expression (which contains subexpressions
...
public class ParseTreeExpressionL4Entry extends AbstractParseTreeExpressionEntry
{
    /**
     ...
     */
    public ParseTreeExpressionL4Entry(final LexicalAnalyser theAnalyser) throws IllegalArgumentException
    {
    ...
    {
        LexicalAnalyser theLexicalAnalyser = getLexicalAnalyser();
        if (theLexicalAnalyser == null) throw new NullPointerException("lexicalAnalyser is null.");

        ArrayList<ParserError> errorList = null;

        // Get the next token to process from the lexical analyser.

        LexicalToken nextToken = theLexicalAnalyser.getNextToken();
        if (nextToken == null)
        {
            // TODO: do end of data handling.
        }
